...
struct DicoverView: View {
    ...
    var body: some View {
        HStack(spacing: 0){
            ...
            NavigationViews_Discover()
            
            
            ZStack{
                CanvasContainerViewOne_Discover()
                
                CanvasContainerViewTwo_Discover()
...
//NavigatorView
struct NavigationViews_Discover : View {
...
//CanvasView
struct CanvasViews_Discover : View {
        ...
        HStack{
            ...
            VStack{
                ...
                VStack(spacing: 0){
                    HStack{
                        Text("Destination Toronto")
                            ...
                            .font(.custom("Menlo Regular",size: 20.5))
                            .fontWeight(.thin)
                        Spacer()
                    }
                ...
                VStack{
                    ...
                    Text("Calgary, Charlottetown, Edmonton ,Halifax ,Montreal ,Ottawa, Winnipeg, Vancouver")
                        .foregroundColor(Color(red: 0.31, green: 0.31, blue: 0.31))
                        .font(.system(size: 20))
                        .fontWeight(.regular)
...
struct  CanvasContainerViewOne_Discover : View {
...
struct  CanvasContainerViewTwo_Discover : View {
